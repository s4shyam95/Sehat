...
//				int intensity = Integer.parseInt(arr[flagIntensity+1].trim());
				...
				ads.open();
				ads.createActivity(sc, duration, Helper.getFitons(duration, flagIntensity, sc._exertion), 7, (int)(Math.random() * 50002));
				ads.close();
				
				getSupportActionBar().setTitle(R.string.app_name);
				getSupportFragmentManager().beginTransaction()
						.add(R.id.container, new FeedbackFragment(7, Helper.getFitons(duration, 7, sc._exertion), sc._parent._name, sc._name)).commit();
...
//				int intensity = Integer.parseInt(arr[flagIntensity+1].trim());
				...
				for(SessionActivity sa : sas){
					ads.createActivity(sa._subcat, sa._duration, Helper.getFitons(sa._duration, 7, sa._subcat._exertion), 7, (int)(Math.random() * 50002));
					fitonsum+=Helper.getFitons(sa._duration, 7, sa._subcat._exertion);
				}
				ads.close();
				//openChiragsFeedbcakFragment
				getSupportActionBar().setTitle(R.string.app_name);
				getSupportFragmentManager().beginTransaction()
						.add(R.id.container, new FeedbackFragment(7, fitonsum, sessionname)).commit();
