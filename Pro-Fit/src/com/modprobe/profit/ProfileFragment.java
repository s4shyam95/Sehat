...
public class ProfileFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		hl.add(hl.size() - 1 - 2, new Activity(true, "27 January 2017", 0, 1));
		hl.add(hl.size() - 1 - 4, new Activity(true, "28 January 2017", 0, 4));
		hl.add(0, new Activity(true, "29 January 2017", 0, 7));
