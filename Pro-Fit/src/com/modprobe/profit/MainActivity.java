...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Intent in = new Intent(this, HealthActivity.class);
		// startActivity(in);
		...
		if (savedInstanceState == null) {
            ...
            if (lang.equals("none")) {
                        Intent i = new Intent(getApplicationContext(), SelectLangaugeActivity.class);
                        startActivity(i);
            } else {
...
//               getSupportActionBar().setTitle(R.string.app_name);
	...
	private void seedDb() {
		...
		wlds.open();
		wlds.createWeightLog("27/1/17", 55, 0);
		wlds.createWeightLog("28/1/17", 59, 1);
		wlds.createWeightLog("29/1/17", 56, 2);
		wlds.close();
